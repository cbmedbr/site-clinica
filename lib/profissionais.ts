...
export const profissionais: Prof[] = [
  ...
  },
  {
    ...
    demandas: 'Especializada em oferecer suporte a pessoas em momentos de perda, luto social, luto simbólico, luto parental, luto conjugal, luto por suicídio, luto por morte súbita, luto por morte violenta, luto por separação ou divórcio, luto por perda da saúde, luto pela perda do pet, luto por perda funcional, luto migratório, luto institucional, Síndrome do Ninho Vazio, Mães Atípicas, Mães de Anjos e Mães Neurodivergentes, Ansiedade, Depressão, Medo, Fobia Social, Dependência Emocional, Crises Existenciais, Traumas, Estresse, Estresse Pós-Traumático, Depêndencia Química, Alcoolismo, Violência Doméstica, Violências Sexuais, Distúrbios Alimentares (anorexia e bulimia), Transtorno de Imagem, Transtorno de Humor, Bipolar, Bordeline, Abandono de Incapaz, Dificuldades na Dinâmica Conjugal e Afetiva, Sofrimento no vínculo amoroso, Feridas emocionais na relação, Dores no campo afetivo, Vivências de frustração relacional, Divórcio/Separação, Burnout, Bullying, Pais em Processo de Filiação Adotiva, Aspectos relacionados à Identidade de Gênero e à Orientação Sexual, Desafios no Reconhecimento e Afirmação da Identidade.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, SC Saúde, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
